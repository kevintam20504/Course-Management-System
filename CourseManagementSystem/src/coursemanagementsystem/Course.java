...
public class Course {
    ...
    public HashMap<Course, HashMap<Student, ArrayList<String>>> getStudentFeedback() {
        return studentFeedback;
    }

    public void setStudentFeedback(HashMap<Course, HashMap<Student, ArrayList<String>>> studentFeedback) {
